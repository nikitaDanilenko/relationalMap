...
>      [(0, [1,2,4]),(1,[2,3,5]),(2,[5]),(3,[0,2,4]),(4,[1,2]),(5,[0,3,4])] (Plain "T6")
 
> testTournamentDim7 :: Rel N7 N7
> testTournamentDim7 = fromNumbersFull
>      [(0,[2,6]),(1,[0,2,4,5,6]),(2,[4,5,6]),(3,[0,1,2,5]),(4,[0,3,6]),(5,[0,4]),(6,[3,5])] (Plain "T7")
 
> testTournamentDim10 :: Rel N10 N10
> testTournamentDim10 = fromNumbersFull [(0,[2,3,5,8]),(1,[0,3,7,8,9]),(2,[1,3,4,6,8]),(3,[5,6,8]),(4,[0,1,3,6,7,8]),(5,[1,2,4,6,8]),(6,[0,1,9]),(7,[0,2,3,5,6,9]),(8,[6,7,9]),(9,[0,2,3,4,5])] (Plain "T10")